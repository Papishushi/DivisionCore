...
namespace ExternDependencies {
    ...
    private:
        ...
        public:
            ...
            virtual _connection_base4<arg1_type, arg2_type, arg3_type, arg4_type, mt_policy> *
            duplicate(has_slots<mt_policy> *pnewdest) = 0;
        };
        ...
        public:
            ...
            duplicate(has_slots<mt_policy> *pnewdest) {
                return new _connection3<dest_type, arg1_type, arg2_type, arg3_type, mt_policy>((dest_type *) pnewdest,
                                                                                               m_pmemfun);
            }
        ...
        public:
            ...
            void emit() {
                lock_block<mt_policy> lock(this);
                typename _signal_base0<mt_policy>::connections_list::const_iterator itNext, it = this->m_co;
                this->nnected_slots.begin();
                typename _signal_base0<mt_policy>::connections_list::const_iterator itEnd = this->m_connected_slots.end();

                while (this->it != this->itEnd) {
                    this->itNext = this->it;
                    ++this->itNext;
        ...
        public:
            ...
            void emit(arg1_type a1, arg2_type a2, arg3_type a3, arg4_type a4,
                ...
                while (this->it != this->itEnd) {
                    ...
                    (*this->it)->emit(a1, a2, a3, a4, a5, a6);
        ...
        public:
            ...
            void emit(arg1_type a1, arg2_type a2, arg3_type a3, arg4_type a4,
                ...
                while (this->it != this->itEnd) {
                    ...
                    (*this->it)->emit(a1, a2, a3, a4, a5, a6, a7);
        ...
        public:
            ...
            void emit(arg1_type a1, arg2_type a2, arg3_type a3, arg4_type a4,
                ...
                while (this->it != this->itEnd) {
                    ...
                    (*this->it)->emit(a1, a2, a3, a4, a5, a6, a7, a8);
